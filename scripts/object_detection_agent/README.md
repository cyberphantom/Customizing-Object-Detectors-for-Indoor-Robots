DUNet model is built on the forked and heavily modified https://github.com/pierluigiferrari/ssd_keras which is an SSD implementation with tensorflow backend
